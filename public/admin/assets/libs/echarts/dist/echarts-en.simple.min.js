!(function (t, e) {
    ...
    function s() {
        return ah || (ah = rh().getContext("2d")), ah;
    }
    function l(t, e) {
        if (t) {
    ...
    function f(t, e, n) {
        if (t && e)
            if (t.forEach && t.forEach === Ql) t.forEach(e, n);
    ...
    function d(t, e, n) {
        if (t && e) {
            if (t.map && t.map === eh) return t.map(e, n);
    ...
    function p(t, e, n, i) {
        if (t && e) {
            if (t.reduce && t.reduce === nh) return t.reduce(e, n, i);
    ...
    function g(t, e, n) {
        if (t && e) {
            if (t.filter && t.filter === Jl) return t.filter(e, n);
            for (var i = [], r = 0, a = t.length; r < a; r++)
    ...
    function yt(t, e) {
        kh && vt(kh, e), (kh = Dh.put(t, kh || e.slice()));
    }
    function _t(t, e) {
        if (t) {
            e = e || [];
            ...
            if (i in Ch) return vt(e, Ch[i]), yt(t, e), e;
            if ("#" !== i.charAt(0)) {
                var r = i.indexOf("("),
                    a = i.indexOf(")");
                if (-1 !== r && a + 1 === i.length) {
                    ...
                    switch (o) {
                        ...
                        case "rgb":
                            return 3 !== s.length
                                ? void mt(e, 0, 0, 0, 1)
                                : (mt(e, dt(s[0]), dt(s[1]), dt(s[2]), l),
                                  yt(t, e),
                                  e);
                        case "hsla":
                            return 4 !== s.length
                                ? void mt(e, 0, 0, 0, 1)
                                : ((s[3] = pt(s[3])), xt(s, e), yt(t, e), e);
                        case "hsl":
                            return 3 !== s.length
                                ? void mt(e, 0, 0, 0, 1)
                                : (xt(s, e), yt(t, e), e);
    ...
    function Ct(t, e, n, i, r) {
        var a = t.length;
        if (1 == r) for (s = 0; s < a; s++) i[s] = It(t[s], e[s], n);
        else
    ...
    function Dt(t, e, n) {
        ...
        if (i !== r)
            if (i > r) t.length = r;
            else for (o = i; o < r; o++) t.push(1 === n ? e[o] : Ah.call(e[o]));
    ...
    function Pt(t) {
        if (c(t)) {
            var e = t.length;
            if (c(t[0])) {
                for (var n = [], i = 0; i < e; i++) n.push(Ah.call(t[i]));
                return n;
            }
            return Ah.call(t);
        }
    ...
    function Gt(t, e) {
        function n(n) {
            var s = a[n],
                ...
                c = o[n + 1];
            (o[n] = h + c),
                n === l - 3 && ((a[n + 1] = a[n + 2]), (o[n + 1] = o[n + 2])),
                l--;
            var f = Ht(t[u], t, s, h, 0, e);
            (s += f),
                0 !== (h -= f) &&
                    0 !== (c = Wt(t[s + h - 1], t, u, c, c - 1, e)) &&
    ...
    function qt(t, e, n, i) {
        ...
        if (!(r < 2)) {
            var a = 0;
            if (r < Hh) return (a = zt(t, n, i, e)), void Vt(t, n, i, n + a, e);
            var o = new Gt(t, e),
                s = Nt(r);
            do {
                if ((a = zt(t, n, i, e)) < s) {
    ...
    function te(t, e) {
        ...
        return iu > ru && ((iu = 0), (nu = {})), iu++, (nu[n] = r), r;
    }
    ...
    function he(t, e) {
        ...
        for (var o = 0; ; o++) {
            ...
            var s =
                0 === o
                    ? ue(t, r, e.ascCharWidth, e.cnCharWidth)
                    : a > 0
    ...
    function de(t, e, n, i) {
        ...
        if ((n && (s += n[0] + n[2]), t && i)) {
            ...
            if (null != l && s > l) (t = ""), (a = []);
                ...
                for (
                    var u = le(h - (n ? n[1] + n[3] : 0), e, i.ellipsis, {
                            minChar: i.minChar,
    ...
    function pe(t, e) {
        ...
        for (A = 0; A < o.length; A++) {
            for (var p = o[A], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
                var y =
                        ((L = p.tokens[v]).styleName && e.rich[L.styleName]) ||
                        {},
                ...
                if ("string" == typeof b && "%" === b.charAt(b.length - 1))
                    ...
                    if (S) {
                        ...
                        I &&
                            Jt((I = $t(I))) &&
                            (b = Math.max(b, (I.width * w) / I.height));
                    }
                    var T = _ ? _[1] + _[3] : 0;
                    b += T;
                    ...
                    null != k &&
                        k < b &&
                        (!S || k < T
                            ? ((L.text = ""), (L.textWidth = b = 0))
                            : ((L.text = se(L.text, k - T, x, c.ellipsis, {
                                  minChar: c.minChar,
                              })),
                              (L.textWidth = te(L.text, x)),
                              (b = L.textWidth + T)));
        ...
        (n.outerWidth = n.width = C(e.textWidth, l)),
            ...
            u &&
                ((n.outerWidth += u[1] + u[3]), (n.outerHeight += u[0] + u[2]));
    ...
    function ve(t, e) {
        ...
        n + i > l && ((n *= l / (c = n + i)), (i *= l / c)),
            r + a > l && ((r *= l / (c = r + a)), (a *= l / c)),
            i + r > h && ((i *= h / (c = i + r)), (r *= h / c)),
            n + a > h && ((n *= h / (c = n + a)), (a *= h / c)),
            t.moveTo(o + n, s),
            t.lineTo(o + l - i, s),
    ...
    function we(t, e, n, i, r) {
        ...
        (s && !t.__dirty) ||
            (s = t.__textCotentBlock = de(n, a, o, i.truncate));
        var l = s.outerHeight,
            h = s.lines,
            u = s.lineHeight,
            c = ke(l, i, r),
        ...
        var b = i.textStrokeWidth,
            S = Le(i.textStroke, b),
            M = Pe(i.textFill);
        S && (Ae(e, "lineWidth", b), Ae(e, "strokeStyle", S)),
            M && Ae(e, "fillStyle", M);
        ...
        for (var _ = 0; _ < n.lines.length; _++) {
            for (
                var x,
                    ...
                    D = y,
                    k = S - 1;
                T < S && (!(x = b[T]).textAlign || "left" === x.textAlign);
    ...
    function Ie(t, e, n, i, r, a, o, s) {
        ...
        var c = n.textPadding;
        c && ((o = Ee(o, s, c)), (u -= n.height / 2 - c[2] - n.textHeight / 2)),
            ...
            Ae(
                e,
                "shadowOffsetX",
                D(l.textShadowOffsetX, i.textShadowOffsetX, 0)
            ),
            Ae(
                e,
                "shadowOffsetY",
                D(l.textShadowOffsetY, i.textShadowOffsetY, 0)
            ),
            Ae(e, "textAlign", s),
            Ae(e, "textBaseline", "middle"),
            Ae(e, "font", n.font || ou);
        ...
        f &&
            ...
            d && (Ae(e, "fillStyle", d), e.fillText(n.text, o, u));
    }
    function Te(t) {
        return (
    ...
    function Ce(t, e, n, i, r, a, o) {
        var s = n.textBackgroundColor,
            ...
            u = x(s);
        if (
            (Ae(e, "shadowBlur", n.textBoxShadowBlur || 0),
            ...
            c
                ? ve(e, { x: i, y: r, width: a, height: o, r: c })
                : e.rect(i, r, a, o),
                e.closePath();
        }
    ...
    function ke(t, e, n) {
        ...
        if (n) {
            ...
            if (s instanceof Array)
                (i = n.x + Oe(s[0], n.width)), (r = n.y + Oe(s[1], n.height));
            else {
    ...
    function Re(t) {
        ...
        (this.style = new Yh(t.style, this)),
            (this._rect = null),
            (this.__clipPaths = []);
    }
    function Ne(t) {
    ...
    function Qe(t) {
        return "mousewheel" === t && Ul.browser.firefox ? "DOMMouseScroll" : t;
    }
    function Je(t, e, n) {
        var i = t._gestureMgr;
        "start" === n && i.clear();
    ...
    function rn(t) {
        ...
        ch.call(this),
            ...
            (this._handlers = {}),
            nn(this),
            Ul.pointerEventsSupported
                ? e(Su, this)
                : (Ul.touchEventsSupported && e(wu, this), e(xu, this));
    }
    function an(t, e) {
        ...
        ku(t, function (t, n) {
            ...
            ku(t, function (t, n) {
                ...
                if (Au(r)) {
                    if (
                        ((a.name =
                            null != r.name ? r.name + "" : i ? i.name : Pu + n),
                        i)
                    )
                        a.id = i.id;
    ...
    function Sn(t) {
        var e = ["__\0is_clz", Nu++, Math.random().toFixed(3)].join("_");
        (t.prototype[e] = !0),
    ...
    function Tn(t, e) {
        function n(t) {
            var e = i[t.main];
            return (e && e[Ru]) || ((e = i[t.main] = {})[Ru] = !0), e;
        }
        e = e || {};
        var i = {};
        if (
    ...
    function Ln(t, e, n, i, r, a) {
        ...
        if (Cn(u) && Cn(c))
            ...
            if (Cn(p)) {
                ...
                (M =
                    (-s -
                        ((y = y < 0 ? -Gu(-y, Yu) : Gu(y, Yu)) +
                            (_ = _ < 0 ? -Gu(-_, Yu) : Gu(_, Yu)))) /
                    (3 * o)) >= 0 &&
                    M <= 1 &&
                    (a[d++] = M);
            } else {
                var x = (2 * u * s - 3 * o * c) / (2 * qu(u * u * u)),
                    ...
                    S = Math.cos(w),
                    M = (-s - 2 * b * S) / (3 * o),
                    m = (-s + b * (S + Uu * Math.sin(w))) / (3 * o),
                    I = (-s + b * (S - Uu * Math.sin(w))) / (3 * o);
                M >= 0 && M <= 1 && (a[d++] = M),
                    m >= 0 && m <= 1 && (a[d++] = m),
                    I >= 0 && I <= 1 && (a[d++] = I);
            }
            ...
            (f = c - m),
                ...
                f >= 0 && p < v
                    ...
                    : ((Ku[0] = kn(t, n, r, o, d)),
                      (Ku[1] = kn(e, i, a, s, d)),
                      (g = hh(Ku, ju)),
                      d <= 1 && g < v ? ((c = d), (v = g)) : (m *= 0.5));
        return (
            u && ((u[0] = kn(t, n, r, o, c)), (u[1] = kn(e, i, a, s, c))), qu(v)
        );
    }
    function Bn(t, e, n, i) {
        var r = 1 - i;
    ...
    function Vn(t, e, n, i, r, a, o, s, l) {
        ...
        for (var f = 0; f < 1; f += 0.05)
            ($u[0] = Bn(t, n, r, f)),
                ...
                (m = hh(ju, $u)) < c && ((h = f), (c = m));
        c = 1 / 0;
        for (var d = 0; d < 32 && !(u < Zu); d++) {
            var p = h - u,
                g = h + u;
            ($u[0] = Bn(t, n, r, p)), ($u[1] = Bn(e, i, a, p));
            var m = hh($u, ju);
            if (p >= 0 && m < c) (h = p), (c = m);
            else {
                (Ku[0] = Bn(t, n, r, g)), (Ku[1] = Bn(e, i, a, g));
                var v = hh(Ku, ju);
                g <= 1 && v < c ? ((h = g), (c = v)) : (u *= 0.5);
            }
        }
        return l && ((l[0] = Bn(t, n, r, h)), (l[1] = Bn(e, i, a, h))), qu(c);
    }
    ...
    function Hn(t, e, n, i, r, a, o, s, l, h) {
        ...
        for (
            ...
            (l[0] = Qu(p, l[0])), (h[0] = Ju(p, h[0]));
        }
        for (d = c(e, i, a, s, sc), u = 0; u < d; u++) {
            var g = f(e, i, a, s, sc[u]);
            (l[1] = Qu(g, l[1])), (h[1] = Ju(g, h[1]));
        }
        (l[0] = Qu(t, l[0])),
            (h[0] = Ju(t, h[0])),
            (l[0] = Qu(o, l[0])),
    ...
    function Xn(t, e, n, i, r, a, o) {
        ...
        var u =
            (l = (e - i) / (t - n)) * a - o + (h = (t * i - n * e) / (t - n));
        return (u * u) / (l * l + 1) <= ((s / 2) * s) / 2;
    }
    function Zn(t, e, n, i, r, a, o, s, l, h, u) {
        if (0 === l) return !1;
        var c = l;
        return (
            !(
                ...
                (h < t - c && h < n - c && h < r - c && h < o - c)
            ) && En(t, e, n, i, r, a, o, s, h, u, null) <= c / 2
        );
    }
    function Un(t, e, n, i, r, a, o, s, l) {
        ...
        return (
            !(
                ...
                (s > t + h && s > n + h && s > r + h) ||
                (s < t - h && s < n - h && s < r - h)
            ) && Vn(t, e, n, i, r, a, s, l, null) <= h / 2
        );
    }
    function Yn(t) {
        return (t %= wc) < 0 && (t += wc), t;
    }
    function jn(t, e, n, i, r, a, o, s, l) {
        ...
        if (Math.abs(i - r) % bc < 1e-4) return !0;
        if (a) {
            var c = i;
            (i = Yn(r)), (r = Yn(c));
        } else (i = Yn(i)), (r = Yn(r));
    ...
    function ti(t, e, n, i, r, a, o, s) {
        ...
        if (h >= 0 && h <= 1) {
            for (var u = 0, c = Bn(e, i, a, h), f = 0; f < l; f++) {
                d = 0 === Tc[f] || 1 === Tc[f] ? 0.5 : 1;
                (p = Bn(t, n, r, Tc[f])) < o ||
                    (Tc[f] < h ? (u += c < e ? d : -d) : (u += a < c ? d : -d));
            }
            return u;
        }
        var d = 0 === Tc[0] || 1 === Tc[0] ? 0.5 : 1,
            p = Bn(t, n, r, Tc[0]);
        ...
        for (var u = 0, c = 0; c < 2; c++) {
            ...
            if (f + t > o) {
                var d = Math.atan2(s, f),
                    p = a ? 1 : -1;
                d < 0 && (d = Mc + d),
                    ((d >= i && d <= r) || (d + Mc >= i && d + Mc <= r)) &&
                        (d > Math.PI / 2 && d < 1.5 * Math.PI && (p = -p),
                        (u += p));
            }
        }
        return u;
    ...
    function ni(t, e, n, i, r) {
        for (var a = 0, o = 0, s = 0, l = 0, h = 0, u = 0; u < t.length; ) {
            var c = t[u++];
            switch (
                (c === Sc.M && u > 1 && (n || (a += $n(o, s, l, h, i, r))),
                1 == u && ((l = o = t[u]), (h = s = t[u + 1])),
                c)
            ) {
                case Sc.M:
                    (o = l = t[u++]), (s = h = t[u++]);
                ...
                case Sc.Q:
                    if (n) {
                        if (Un(o, s, t[u++], t[u++], t[u], t[u + 1], e, i, r))
                            return !0;
                    } else
                        a +=
                            ti(o, s, t[u++], t[u++], t[u], t[u + 1], i, r) || 0;
                    (o = t[u++]), (s = t[u++]);
                    break;
                case Sc.A:
                    var f = t[u++],
                    ...
                    var w = ((i - f) * g) / p + f;
                    if (n) {
                        if (jn(f, d, g, m, m + v, y, e, w, r)) return !0;
    ...
    function si(t) {
        ...
        var e,
            n = t
                ...
                .replace(/ /g, ",")
                .replace(/,,/g, ",");
        for (e = 0; e < Rc.length; e++)
            n = n.replace(new RegExp(Rc[e], "g"), "|" + Rc[e]);
        var i,
            r = n.split("|"),
            a = 0,
            o = 0,
    ...
    function fi(t, e, n) {
        ...
        if (i && i.length >= 2) {
            if (r && "spline" !== r) {
                ...
                "spline" === r && (i = $c(i, n)), t.moveTo(i[0][0], i[0][1]);
    ...
    function di(t, e, n) {
        ...
        return null === i || null === r
            ? [
                  (n ? An : kn)(t.x1, t.cpx1, t.cpx2, t.x2, e),
                  (n ? An : kn)(t.y1, t.cpy1, t.cpy2, t.y2, e),
              ]
            : [
                  (n ? Rn : Bn)(t.x1, t.cpx1, t.x2, e),
                  (n ? Rn : Bn)(t.y1, t.cpy1, t.y2, e),
              ];
    }
    function pi(t) {
        Re.call(this, t),
    ...
    function xi(t) {
        var e = t.shape,
            n = t.style.lineWidth;
        return (
            cf(2 * e.x1) === cf(2 * e.x2) && (e.x1 = e.x2 = wi(e.x1, n, !0)),
    ...
    function Si(t) {
        return "string" == typeof t ? wt(t, -0.1) : t;
    }
    function Mi(t) {
        ...
        if (!t.__isHover) {
            if ((Mi(t), t.useHoverLayer))
                ...
                n && Hi(e),
                    ...
                    n &&
                        (Wi(e, e.insideOriginalTextPosition, n),
    ...
    function Ai(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
            (!this.__isEmphasis && Ci(this));
    }
    function Li(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
            (!this.__isEmphasis && Di(this));
    }
    function Pi() {
    ...
    function Bi(t, e, n, i, r, a, o) {
        ...
        (c || f) &&
            ...
            null == s &&
                (s = _(r.defaultText) ? r.defaultText(h, r) : r.defaultText));
        var d = c ? s : null,
            p = f
                ? C(l ? l.getFormattedLabel(h, "emphasis", null, u) : null, s)
                : null;
        (null == d && null == p) || (Ri(t, n, a, r), Ri(e, i, o, r, !0)),
            (t.text = d),
            (e.text = p);
    }
    ...
    function Fi(t, e, n, i, r, a) {
        if (
            ...
            (t.textStroke =
                Vi(e.getShallow("textBorderColor"), i) || n.textBorderColor),
            (t.textStrokeWidth = C(
        ...
        (t.fontStyle = e.getShallow("fontStyle") || n.fontStyle),
            ...
            (t.textShadowBlur =
                e.getShallow("textShadowBlur") || n.textShadowBlur),
            (t.textShadowOffsetX =
    ...
    function Ui(t, e, n) {
        return (
            e && !c(e) && (e = yh.getLocalTransform(e)),
            n && (e = lt([], e)),
            U([], t, e)
        );
    }
    ...
    function ar(t, e, n) {
        ...
        for (
            ...
            for (
                var u = Number.NEGATIVE_INFINITY, c = null, f = 0, g = h.length;
                f < g;
                ++f
            )
                h[f] > u && ((u = h[f]), (c = f));
    ...
    function yr(t, e, n, i, r) {
        ...
        e.eachChild(function (l, h) {
            ...
            if ("horizontal" === t) {
                ...
                (u = a + m) > i || l.newline
                    ? ((a = 0), (u = m), (o += s + n), (s = d.height))
                    : (s = Math.max(s, d.height));
            } else {
                var v = d.height + (g ? -g.y + d.y : 0);
                (c = o + v) > r || l.newline
                    ? ((a += s + n), (o = 0), (c = v), (s = d.width))
    ...
    function Tr(t) {
        (this.fromDataset = t.fromDataset),
            ...
            (this.seriesLayoutBy = t.seriesLayoutBy || Zf),
    ...
    function Lr(t, e, n, i, r) {
        if (!t) return { dimensionsDefine: Pr(r) };
        var a, o, s;
        if (e === Wf)
            "auto" === i || null == i
                ? Or(
    ...
    function ea(t, e, n) {
        if (t && t[e] && (t[e].normal || t[e].emphasis)) {
            ...
            i &&
                (n
                    ? ((t[e].normal = t[e].emphasis = null), o(t[e], i))
                    : (t[e] = i)),
    ...
    function aa(t) {
        if (ad(t)) {
            ...
            if ("graph" === t.type) {
                ...
                if (a && !S(a)) for (s = 0; s < a.length; s++) ra(a[s]);
                f(t.categories, function (t) {
                    na(t);
                });
            }
            if (r && !S(r)) for (s = 0; s < r.length; s++) ra(r[s]);
            ...
            "gauge" === t.type
                ? (ia(t, "axisLabel"), ia(t, "title"), ia(t, "detail"))
                : "treemap" === t.type &&
                  (ea(t.breadcrumb, "itemStyle"),
        ...
        f(t, function (e, n) {
            var i = [],
                ...
                l = o.map(a, function (a, l, h) {
                    ...
                    s
                        ? (f = o.getRawIndex(h))
                        : (c = o.get(e.stackedByDimension, h));
                    for (var d = NaN, p = n - 1; p >= 0; p--) {
                        var g = t[p];
                        if (
                            (s ||
                                (f = g.data.rawIndexOf(
                                    g.stackedByDimension,
                                    c
                                )),
                            f >= 0)
                        ) {
                            var m = g.data.getByRawIndex(
                                g.stackResultDimension,
                                f
                            );
                            if ((u >= 0 && m > 0) || (u <= 0 && m < 0)) {
                                (u += m), (d = m);
    ...
    function fa(t, e) {
        ...
        var n = (this._data = t.data),
            i = t.sourceFormat;
        i === Xf && ((this._offset = 0), (this._dimSize = e), (this._data = n)),
    ...
    function _a(t, e, n) {
        if (t) {
            ...
            if (null != i) {
                ...
                return s && ((r = s.name), (a = s.index)), dd[o](i, e, a, r);
            }
        }
    }
    function xa(t, e, n) {
        if (t) {
            ...
            if (i === Vf || i === Hf) {
                ...
                return i !== Vf || w(r) || (r = null), r ? r[n] : void 0;
            }
        }
    }
    function wa(t) {
    ...
    function Ia(t) {
        var e = t.getRawData(),
            n = [];
        return (
            f(e.mapDimension("seriesName", !0), function (t) {
    ...
    function Ca(t) {
        var e = t.model;
        return e.setData(e.getRawData().cloneShallow()), Da;
    }
    function Da(t, e) {
    ...
    function Pa() {
        (this.group = new Wh()),
            ...
            (this.renderTask = wa({ plan: Ba, reset: Ra })),
            (this.renderTask.context = { view: this });
    }
    function Oa(t, e) {
        if (t && (t.trigger(e), "group" === t.type))
            for (var n = 0; n < t.childCount(); n++) Oa(t.childAt(n), e);
    }
    function Ea(t, e, n) {
        var i = pn(t, e);
        null != i
    ...
    function Ra(t) {
        ...
        return "render" !== l && o[l](e, n, i, r), Td[l];
    }
    function Na(t, e, n) {
        function i() {
                ...
                if (u) {
                    ...
                    h &&
                        h.each(function (s, l) {
                            ...
                            (h.skip =
                                !e.performRawSeries &&
                                n.isSeriesFiltered(s.context.model)),
                                Pd(s, i),
                                (o |= s.perform(h));
                        });
            }
    ...
    function Va(t, e, n, i, r) {
        function a(n) {
            var a = n.uid,
                s =
                    o.get(a) ||
                    o.set(a, wa({ plan: Za, reset: Ua, count: ja }));
            (s.context = {
                model: n,
                ecModel: i,
                api: r,
    ...
    function Wa(t, e, n, i, r) {
        function a(e) {
            var n = e.uid,
                i = s.get(n) || s.set(n, wa({ reset: Ga, onDirty: Xa }));
            (i.context = { model: e, overallProgress: u, isOverallFilter: c }),
                (i.agent = o),
                (i.__block = u),
                $a(t, e, i);
        }
        var o = (n.overallTask = n.overallTask || wa({ reset: Ha }));
        o.context = {
            ecModel: i,
            api: r,
    ...
    function Ua(t) {
        if (
            ...
            (t.resetDefines = on(t.reset(t.model, t.ecModel, t.api, t.payload)))
                .length)
        )
            return Ya;
    }
    ...
    function Ja(t) {
        return function (e, n, i) {
            (e = e && e.toLowerCase()), ch.prototype[t].call(this, e, n, i);
        };
    }
    function to() {
        ch.call(this);
    ...
    function eo(t, e, i) {
        ...
        (this._throttledZrFlush = Na(m(a.flush, a), 17)),
            (e = n(e)) && ud(e, !0),
            (this._theme = e),
            (this._chartsViews = []),
            (this._chartsMap = {}),
    ...
    function ro(t, e, n, i, r) {
        ...
        } else Wd(t._componentsViews.concat(t._chartsViews), a);
    }
    function ao(t, e) {
        var n = t._chartsMap,
            i = t._scheduler;
    ...
    function oo(t, e) {
        ...
        Wd(
            ...
            "none" === h ||
                ...
                l ||
                (this[Kd]
                    ? (io(this), tp.update.call(this, t), (this[Kd] = !1))
                    : tp[h].call(this, t)),
            (f = c ? { type: s.event || n, escapeConnect: i, batch: p } : p[0]),
            (this[$d] = !1),
    ...
    function uo(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var u = qd(t.type);
                (r = new (
                    a ? xd.getClass(u.main, u.sub) : Pa.getClass(u.sub)
                )()).init(n, h),
                    (s[e] = r),
                    o.push(r),
                    l.add(r.group);
    ...
    function Co(t, e, n) {
        ...
        var i = Gd(t) ? t.type : [t, (t = { event: e })][0];
        (t.event = (t.event || i).toLowerCase()),
            (e = t.event),
            Vd(Qd.test(i) && Qd.test(e)),
            np[i] || (np[i] = { action: n, actionInfo: t }),
            (ip[e] = i);
    }
    function Do(t, e) {
        Ao(sp, t, e, Ud, "layout");
    ...
    function No(t, e, n, i, r) {
        (this._old = t),
            (this._new = e),
            (this._oldKeyGetter = n || Ro),
            (this._newKeyGetter = i || Ro),
            (this.context = r);
    }
        ...
        f(t.dimensions, function (e) {
            ...
            if (o) {
                ...
                n.hasOwnProperty(o) || (s = n[o] = []),
                    (s[a.coordDimIndex] = e),
                    a.isExtraCoord || (i.set(o, 1), Wo(a.type) && (r[0] = e));
            }
    ...
    function Jo(t, e, i) {
        function r(t, e, n) {
            null != yp.get(e)
                ? (t.otherDims[e] = n)
                : ((t.coordDim = e), (t.coordDimIndex = n), u.set(e, !0));
        }
        Tr.isInstance(e) || (e = Tr.seriesDataToSource(e)),
            (i = i || {}),
            (t = (t || []).slice());
        for (
            var s = (i.dimsDef || []).slice(),
                l = R(i.encodeDef),
                h = R(),
                u = R(),
                c = [],
                d = ts(e, t, s, i.dimCount),
                p = 0;
            p < d;
            p++
        ) {
            ...
            null != m &&
                null == h.get(m) &&
                ((v.name = v.displayName = m), h.set(m, p)),
        ...
        for (var M = _ || "value", I = 0; I < d; I++)
            null == (v = c[I] = c[I] || {}).coordDim &&
                ...
                null == v.type && Nr(e, I, v.name) && (v.type = "ordinal");
        return c;
    }
    function ts(t, e, n, i) {
        var r = Math.max(
    ...
    function is(t, e, n) {
        return (
            e &&
            e === t.getCalculationInfo("stackedDimension") &&
            (null != n
                ? n === t.getCalculationInfo("stackedByDimension")
                : t.getCalculationInfo("isStackedByIndex"))
        );
    }
    function rs(t, e, n) {
        ...
        var s,
            l,
            h = kp(t, { coordDimensions: i, generateCoord: n.generateCoord });
        o &&
            f(h, function (t, e) {
                var n = t.coordDim,
    ...
    function ls(t, e, n, i, r, a, o) {
        ...
        return (
            (l =
                0 === t.indexOf("image://")
                    ? vi(t.slice(8), new Rt(e, n, i, r), o ? "center" : "cover")
                    : 0 === t.indexOf("path://")
                    ? mi(
                          t.slice(7),
                          {},
    ...
    function fs(t, e, n) {
        Wh.call(this), this.updateData(t, e, n);
    }
    function ds(t, e) {
        this.parent.drift(t, e);
    }
    function ps(t) {
        (this.group = new Wh()), (this._symbolCtor = t || fs);
    }
    function gs(t, e, n, i) {
        return (
            e &&
    ...
    function Ss(t, e, n, i, r, a, o, s, l, h, u) {
        return null == h
            ? Ms(e, "x")
                ? Is(t, e, n, i, r, a, o, s, l, "x", u)
                : Ms(e, "y")
                ? Is(t, e, n, i, r, a, o, s, l, "y", u)
    ...
    function Ts(t, e, n, i, r, a, o, s, l, h, u) {
        for (var c = 0, f = n, d = 0; d < i; d++) {
            ...
            if (f === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Up(jp, p);
            else if (l > 0) {
                var g = f + a,
                    m = e[g];
                if (u) for (; m && bs(e[g]); ) m = e[(g += a)];
                var v = 0.5,
                    y = e[c];
                if (!(m = e[g]) || bs(m)) Up($p, p);
                else {
                    bs(m) && !u && (m = p), W(Yp, m, y);
                    var _, x;
                    if ("x" === h || "y" === h) {
                        ...
                        (_ = Math.abs(p[w] - y[w])),
                            (x = Math.abs(p[w] - m[w]));
                    } else (_ = lh(p, y)), (x = lh(p, m));
                    Zp($p, p, Yp, -l * (1 - (v = x / (x + _))));
                }
                qp(jp, jp, s),
                    Xp(jp, jp, o),
                    qp($p, $p, s),
    ...
    function Ps(t, e, n) {
        ...
        var f = new tf({ shape: { x: o, y: s, width: l, height: h } });
        return (
            e &&
                ((f.shape[a ? "width" : "height"] = 0),
                Zi(f, { shape: { width: l, height: h } }, n)),
            f
        );
    }
    function Os(t, e, n) {
        ...
        return (
            e &&
                ((s.shape.endAngle = -a[0] * o),
                Zi(s, { shape: { endAngle: -a[1] * o } }, n)),
            s
        );
    }
    function Es(t, e, n) {
    ...
    function Ws(t, e, n, i) {
        ...
        return (
            qs(
                (r.niceTickExtent = [
                    rg(Math.ceil(t[0] / o) * o, s),
                    rg(Math.floor(t[1] / o) * o, s),
                ]),
                t
            ),
            r
    ...
    function Xs(t, e, n, i) {
        ...
        for (
            var a = n[0];
            a <= n[1] && (r.push(a), (a = rg(a + t, i)) !== r[r.length - 1]);
    ...
    function Ks(t, e) {
        ...
        "ordinal" === a
            ...
            null == o &&
                (o = "ordinal" === a ? (n ? 0 : NaN) : u[0] - i[0] * r),
            null == s &&
                (s = "ordinal" === a ? (n ? n - 1 : NaN) : u[1] + i[1] * r),
            "dataMin" === o
                ? (o = u[0])
        ...
        if (c && "time" === a) {
            var f,
                d = [];
            if (
                (c.eachSeriesByType("bar", function (t) {
                    t.coordinateSystem &&
                        "cartesian2d" === t.coordinateSystem.type &&
                        (d.push(t), (f |= t.getBaseAxis() === e.axis));
                }),
                f)
            ) {
                var p = Qs(o, s, e, d);
    ...
    function Qs(t, e, n, i) {
        var r = n.axis.getExtent(),
            a = r[1] - r[0],
            o = Ys(i)[n.axis.dim + n.axis.index];
        ...
        if ((e = e || t.get("type")))
            switch (e) {
                ...
                case "value":
                    return new og();
                default:
                    return (Ns.getClass(e) || og).create(t);
            }
    }
    ...
    function cl(t, e, n) {
        ...
        if (n.onZero) {
            ...
            } else (o = i[r]) && fl(o) && (n.onZero = !1);
        }
    }
    function fl(t) {
        return "category" === t.type || "time" === t.type || !Rg(t);
    }
    function dl(t, e) {
        var n = t.getExtent(),
            i = n[0] + n[1];
    ...
    function _l(t, e, n) {
        ...
        !1 === i
            ? (xl(a), xl(h))
            : wl(a, o) && (i ? (xl(o), xl(u)) : (xl(a), xl(h))),
            !1 === r
                ? (xl(s), xl(c))
                : wl(l, s) && (r ? (xl(l), xl(f)) : (xl(s), xl(c)));
    }
    function xl(t) {
        t && (t.ignore = !0);
    }
                ...
                f(o, function (l, f) {
                    if (!qg(i, f, n.labelInterval, o.length, g, m)) {
                        ...
                        u &&
                            u[l] &&
                            u[l].textStyle &&
                            (v = new ji(u[l].textStyle, r, e.ecModel));
                        var y =
                                v.getTextColor() ||
                                e.get("axisLine.lineStyle.color"),
                            _ = [
                                i.dataToCoord(l),
                                n.labelOffset + n.labelDirection * a,
                            ],
    ...
    function Al(t, e, n, i, r, a) {
        ...
        if (o) {
            var s = Cl(e);
            s
                ? (t._axisPointer || (t._axisPointer = new o())).render(
                      e,
                      s,
                      i,
                      a
    ...
    function Pl(t, e, n) {
        ...
        (a.labelDirection = a.tickDirection = a.nameDirection = m[o]),
            ...
            T(n.labelInside, e.get("axisLabel.inside")) &&
                (a.labelDirection = -a.labelDirection);
        var v = e.get("axisLabel.rotate");
        return (
            (a.labelRotate = "top" === s ? -v : v),
    ...
    function Bl(t, e, n) {
        (n.style.text = null),
            Xi(n, { shape: { width: 0 } }, e, t, function () {
                n.parent && n.parent.remove(n);
            });
    }
    function Rl(t, e, n) {
        (n.style.text = null),
            Xi(n, { shape: { r: n.shape.r0 } }, e, t, function () {
                n.parent && n.parent.remove(n);
            });
    }
    function Nl(t, e, n, i, r, a, s, l) {
        ...
        l || t.setShape("r", c.get("barBorderRadius") || 0),
            t.useStyle(o({ fill: h, opacity: u }, c.getBarItemStyle()));
        ...
        var p = s
            ...
            ? "left"
            : "right";
        l || Ol(t.style, f, i, h, a, n, p), Ei(t, f);
    }
    function zl(t, e) {
        var n = t.get(em) || 0;
    ...
    function Hl(t, e, n, i, r, a, o) {
        function s(e, n) {
            for (
                ...
                i >= 0 &&
                ((t[i].y -= n),
                !(i > 0 && t[i].y > t[i - 1].y + t[i - 1].height));
                i--
            );
        }
        function l(t, e, n, i, r, a) {
            for (
                var o = e ? Number.MAX_VALUE : 0, s = 0, l = t.length;
                s < l;
                s++
            )
    ...
    function Gl(t, e, n, i, r, a) {
        ...
        Hl(s, e, n, i, 1, r, a), Hl(o, e, n, i, -1, r, a);
        ...
        findHover: function (t, e, n) {
            for (
                ...
                if (
                    ...
                    !i[a].ignore &&
                    (o = tt(i[a], t, e)) &&
                    (!r.topTarget && (r.topTarget = i[a]), o !== fh)
                ) {
                    r.target = i[a];
                    break;
                }
                ...
                ph.prototype[t] = function (e) {
                    ...
                    if ("mousedown" === t)
                        ...
                        if (
                            ...
                            !this._downPoint ||
                            lh(this._downPoint, [e.zrX, e.zrY]) > 4
                        )
                            return;
    ...
    (_h.decomposeTransform = function () {
        if (this.transform) {
            var t = this.parent,
                e = this.transform;
            t && t.transform && (rt(xh, t.invTransform, e), (e = xh));
    ...
    "undefined" != typeof window &&
        (Ph = Math.max(window.devicePixelRatio || 1, 1));
    var Oh = Ph,
        Eh = function () {},
        Bh = Eh,
        Rh = function () {
    ...
    (Wh.prototype = {
        ...
        addChildrenToStorage: function (t) {
            for (var e = 0; e < this._children.length; e++) {
                ...
                t.addToStorage(n), n instanceof Wh && n.addChildrenToStorage(t);
            }
        },
    ...
    qh.prototype = {
        ...
        updateDisplayList: function (t) {
            ...
            (n.length = this._displayListLen), Ul.canvasSupported && qt(n, Xt);
        },
        ...
        addRoot: function (t) {
            t.__storage !== this &&
                (t instanceof Wh && t.addChildrenToStorage(this),
                this.addToStorage(t),
                this._roots.push(t));
        },
        delRoot: function (t) {
    ...
    Yh.prototype = {
        ...
        bind: function (t, e, n) {
            for (
                var i = this, r = n && n.style, a = !r, o = 0;
                o < Uh.length;
                o++
            ) {
                var s = Uh[o],
                    l = s[0];
                (a || i[l] !== r[l]) && (t[l] = Zh(t, l, i[l] || s[1]));
            }
            if (
                ((a || i.fill !== r.fill) && (t.fillStyle = i.fill),
                (a || i.stroke !== r.stroke) && (t.strokeStyle = i.stroke),
                (a || i.opacity !== r.opacity) &&
        ...
        getGradient: function (t, e, n) {
            for (
                var i = ("radial" === e.type ? Ut : Zt)(t, e, n),
                    r = e.colorStops,
                    a = 0;
                a < r.length;
                a++
    ...
    for (var jh = Yh.prototype, $h = 0; $h < Uh.length; $h++) {
        var Kh = Uh[$h];
        Kh[0] in jh || (jh[Kh[0]] = Kh[1]);
    }
    Yh.getGradient = jh.getGradient;
    var Qh = function (t, e) {
        ...
        clear: function (t, e) {
            ...
            if (
                ...
                e.colorStops
                    ...
                    : e.image && (h = Qh.prototype.getCanvasPattern.call(e, i)),
                    i.save(),
                    (i.fillStyle = h || e),
                    i.fillRect(0, 0, r, a),
                    i.restore();
    ...
    su.measureText = function (t, e) {
        var n = s();
        return (n.font = e || ou), n.measureText(t);
    };
    var lu = { left: 1, right: 1, center: 1 },
        hu = { top: 1, bottom: 1, middle: 1 },
        uu = new Rt(),
        cu = function () {};
    (cu.prototype = {
        constructor: cu,
        drawRectText: function (t, e) {
            ...
            if ((null != i && (i += ""), Be(i, n))) {
                ...
                n.transformText
                    ? this.setTransform(t)
                    : r && (uu.copy(e), uu.applyTransform(r), (e = uu)),
                    xe(this, t, i, n, e),
                    t.restore();
            }
        },
        ...
        (Re.prototype = {
            ...
            attrKV: function (t, e) {
                "style" !== t
                    ? Nh.prototype.attrKV.call(this, t, e)
                    : this.style.set(e);
            },
            ...
            useStyle: function (t) {
                return (this.style = new Yh(t, this)), this.dirty(!1), this;
            },
        }),
        h(Re, Nh),
        u(Re, cu),
    ...
    pu.prototype = {
        ...
        _doPaintEl: function (t, e, n, i) {
            ...
            if (
                ...
                0 !== t.style.opacity &&
                (!a || a[0] || a[3]) &&
                (!t.culling || !Ve(t, this._width, this._height))
            ) {
                var o = t.__clipPaths;
                (i.prevElClipPaths && !We(o, i.prevElClipPaths)) ||
                    (i.prevElClipPaths &&
                        (e.ctx.restore(),
                        (i.prevElClipPaths = null),
                        (i.prevEl = null)),
                    o && (r.save(), He(o, r), (i.prevElClipPaths = o))),
        ...
        getLayer: function (t, e) {
            ...
            return (
                n ||
                    (((n = new Jh("zr_" + t, this, this.dpr)).zlevel = t),
                    (n.__builtin__ = !0),
        ...
        insertLayer: function (t, e) {
            var n = this._layers,
                ...
                o = -1,
                s = this._domRoot;
            if (n[t]) Bh("ZLevel " + t + " has been used already");
            else if (Fe(e)) {
                if (r > 0 && t > i[0]) {
                ...
                if ((i.splice(o + 1, 0, t), (n[t] = e), !e.virtual))
                    if (a) {
                        ...
                        s.firstChild
                            ...
                            : s.appendChild(e.dom);
            } else Bh("Layer of zlevel " + t + " is not valid");
        },
        ...
        configLayer: function (t, e) {
            if (e) {
                ...
                for (var r = 0; r < this._zlevelList.length; r++) {
                    ...
                    (a !== t && a !== t + 0.01) || i(this._layers[a], n[t], !0);
                }
            }
        },
        delLayer: function (t) {
        ...
        pathToImage: function (t, e) {
            ...
            (t.position = [u - r.x, f - r.y]),
                ...
                t.updateTransform(),
                t && t.brush(i);
            var v = new Ne({ style: { x: 0, y: 0, image: n } });
            return (
    ...
    var _u = {
        ...
        bu = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 },
        Su = d(xu, function (t) {
        ...
        Mu = {
            mousemove: function (t) {
                (t = Ue(this.dom, t)), this.trigger("mousemove", t);
            },
            mouseout: function (t) {
                var e = (t = Ue(this.dom, t)).toElement || t.relatedTarget;
                if (e != this.dom)
                    for (; e && 9 != e.nodeType; ) {
    ...
    f(
        ...
        function (t) {
            Mu[t] = function (e) {
                (e = Ue(this.dom, e)), this.trigger(t, e);
            };
        }
    );
    var Iu = rn.prototype;
    ...
    var ku = f,
        ...
        Eu = 0,
        Bu = ".",
        Ru = "___EC__COMPONENT__CONTAINER___",
        Nu = 0,
        zu = function (t) {
        ...
        oc = [],
        sc = [],
        lc = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
        hc = [],
        uc = [],
        cc = [],
        fc = [],
    ...
    (xc.prototype = {
        ...
        setScale: function (t, e) {
            (this._ux = yc(1 / Oh / t) || 0), (this._uy = yc(1 / Oh / e) || 0);
        },
        getContext: function () {
            return this._ctx;
        },
        ...
        lineTo: function (t, e) {
            var n =
                yc(t - this._xi) > this._ux ||
                yc(e - this._yi) > this._uy ||
                this._len < 5;
            return (
                this.addData(lc.L, t, e),
                this._ctx &&
                    n &&
                    (this._needsDash()
        ...
        arc: function (t, e, n, i, r, a) {
            return (
                this.addData(lc.A, t, e, n, n, i, r - i, 0, a ? 0 : 1),
        ...
        closePath: function () {
            ...
            return (
                t &&
                    (this._needsDash() && this._dashedLineTo(e, n),
                    t.closePath()),
                (this._xi = e),
                (this._yi = n),
                this
        ...
        _dashedLineTo: function (t, e) {
            ...
            (u = d - t), (c = p - e), (this._dashOffset = -vc(u * u + c * c));
        },
        _dashedBezierTo: function (t, e, n, i, r, a) {
            ...
            for (f < 0 && (f = c + f), f %= c, o = 0; o < 1; o += 0.1)
                (s = v(g, t, n, r, o + 0.1) - v(g, t, n, r, o)),
                    (l = v(m, e, i, a, o + 0.1) - v(m, e, i, a, o)),
                    (y += vc(s * s + l * l));
            for (; _ < x && !((w += d[_]) > f); _++);
            for (o = (w - f) / y; o <= 1; )
                (h = v(g, t, n, r, o)),
        ...
        getBoundingRect: function () {
            ...
            for (
                var t = this.data, e = 0, n = 0, i = 0, r = 0, a = 0;
                a < t.length;
                ...
                Y(hc, hc, cc), j(uc, uc, fc);
            }
            return (
                0 === a && (hc[0] = hc[1] = uc[0] = uc[1] = 0),
                new Rt(hc[0], hc[1], uc[0] - hc[0], uc[1] - hc[1])
            );
        },
    ...
    (ai.prototype = {
        ...
        brush: function (t, e) {
            ...
            l
                ...
                : u && (t.fillStyle = Dc.call(o, t)),
                h
                    ? (t.strokeStyle = this._strokeGradient)
                    : c && (t.strokeStyle = Dc.call(s, t));
            var d = n.lineDash,
                p = n.lineDashOffset,
                g = !!t.setLineDash,
        ...
        attrKV: function (t, e) {
            "shape" === t
                ? (this.setShape(e),
                  (this.__dirtyPath = !0),
                  (this._rect = null))
                : Re.prototype.attrKV.call(this, t, e);
        },
        ...
        getLineScale: function () {
            var t = this.transform;
            return t && kc(t[0] - 1) > 1e-10 && kc(t[3] - 1) > 1e-10
                ? Math.sqrt(kc(t[0] * t[3] - t[2] * t[1]))
                : 1;
        },
    }),
    ...
    var Xc = ai.extend({
        ...
        Uc = function (t) {
            return Ul.browser.ie && Ul.browser.version >= 11
                ? function () {
                      var e,
                          n = this.__clipPaths,
                          i = this.style;
        ...
        $c = function (t, e) {
            ...
            for (a = 0; a < o; a++) {
                ...
                var p = f * f,
                    g = f * p;
                i.push([
                    ci(s[0], d[0], l[0], h[0], f, p, g),
                    ci(s[1], d[1], l[1], h[1], f, p, g),
                ]);
            }
            return i;
        },
        Kc = function (t, e, n, i) {
            ...
            for (var f = 0, d = t.length; f < d; f++) {
                ...
                var y = V([], p, u),
                    _ = V([], p, c);
                i && (j(y, y, o), Y(y, y, s), j(_, _, o), Y(_, _, s)),
                    l.push(y),
                    l.push(_);
            }
    ...
    (lf.prototype = { constructor: lf }), h(lf, sf);
    ...
    (hf.prototype = { constructor: hf }),
        ...
        (pi.prototype.brush = function (t, e) {
            for (n = this._cursor; n < this._displayables.length; n++)
                (i = this._temporaryDisplayables[n]).beforeBrush &&
                    i.beforeBrush(t),
                    i.brush(
                        t,
                        n === this._cursor ? null : this._displayables[n - 1]
                    ),
            ...
            for (var n = 0; n < this._temporaryDisplayables.length; n++) {
                ...
                i.beforeBrush && i.beforeBrush(t),
                    i.brush(
                        t,
                        0 === n ? null : this._temporaryDisplayables[n - 1]
                    ),
                    i.afterBrush && i.afterBrush(t);
            }
    ...
    (pi.prototype.getBoundingRect = function () {
        if (!this._rect) {
            for (
                var t = new Rt(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
                ...
                n.needLocalTransform() &&
                    i.applyTransform(n.getLocalTransform(uf)),
                    t.union(i);
            }
            this._rect = t;
        }
        ...
        gf = (Object.freeze || Object)({
            ...
            clipPointsByRect: function (t, e) {
                return d(t, function (t) {
                    var n = t[0];
                    (n = ff(n, e.x)), (n = df(n, e.x + e.width));
                    var i = t[1];
                    return (
                        (i = ff(i, e.y)), (i = df(i, e.y + e.height)), [n, i]
                    );
                });
            },
            ...
            createIcon: function (t, e, n) {
                var i = ((e = a({ rectHover: !0 }, e)).style = {
                    strokeNoScale: !0,
                });
                if (((n = n || { x: -1, y: -1, width: 2, height: 2 }), t))
                    return 0 === t.indexOf("image://")
                        ? ((i.image = t.slice(8)), o(i, n), new Ne(e))
                        : mi(t.replace("path://", ""), e, n, "center");
            },
            Group: Wh,
            Image: Ne,
            Text: qc,
    ...
    (ji.prototype = {
        ...
        get: function (t, e) {
            return null == t
                ? this.option
                : $i(this.option, this.parsePath(t), !e && Ki(this, t));
        },
        ...
        getModel: function (t, e) {
            var n,
                i =
                    null == t
                        ? this.option
                        : $i(this.option, (t = this.parsePath(t)));
            return (
                (e = e || ((n = Ki(this, t)) && n.getModel(t))),
    ...
    var bf = 0,
        ...
        Ef = ji.extend({
            ...
            $constructor: function (t, e, n, i) {
                ji.call(this, t, e, n, i), (this.uid = Qi("ec_cpt_model"));
            },
    ...
    Tn(Ef, { registerWhenExtend: !0 }),
        ...
        (function (t, e) {
                ...
                if (t.length) {
                    ...
                    for (
                        ...
                        var u = l.pop(),
                            ...
                            d = !!h[u];
                        d &&
                            (i.call(r, u, c.originalDeps.slice()), delete h[u]),
                            f(
                                c.successor,
                                d
                                    ? function (t) {
            ...
            var e = [];
            return (
                f(Ef.getClassesByMainType(t), function (t) {
    ...
    var Rf = {
        ...
        zf = {
            clearColorPalette: function () {
                (Nf(this).colorIdx = 0), (Nf(this).colorNameMap = {});
            },
            getColorFromPalette: function (t, e, n) {
                ...
                if ((l = l || o) && l.length) {
                    var h = l[r];
                    return (
                        t && (a[t] = h), (i.colorIdx = (r + 1) % l.length), h
                    );
                }
            },
        },
        Ff = {
            cartesian2d: function (t, e, n, i) {
                ...
                (e.coordSysDims = ["x", "y"]),
                    n.set("x", r),
                    n.set("y", a),
                    Ir(r) && (i.set("x", r), (e.firstCategoryDimIndex = 0)),
                    Ir(a) && (i.set("y", a), (e.firstCategoryDimIndex = 1));
            },
            singleAxis: function (t, e, n, i) {
                ...
                (e.coordSysDims = ["single"]),
                    n.set("single", r),
                    Ir(r) &&
                        (i.set("single", r), (e.firstCategoryDimIndex = 0));
            },
            polar: function (t, e, n, i) {
                ...
                (e.coordSysDims = ["radius", "angle"]),
                    ...
                    n.set("angle", o),
                    Ir(a) &&
                        (i.set("radius", a), (e.firstCategoryDimIndex = 0)),
                    Ir(o) && (i.set("angle", o), (e.firstCategoryDimIndex = 1));
            },
                ...
                f(a.parallelAxisIndex, function (t, a) {
                    ...
                    n.set(l, s),
                        Ir(s) &&
                            ...
                            (i.set(l, s), (e.firstCategoryDimIndex = a));
                });
            },
        },
        Vf = "original",
        ...
        $f = ji.extend({
                    ...
                    f(t, function (t, r) {
                        null != t &&
                            (Ef.hasClass(r)
                                ? r && o.push(r)
                                : (e[r] =
                                      null == e[r] ? n(t) : i(e[r], t, !0)));
                    }),
                    Ef.topologicalTravel(
                        o,
                        Ef.getAllClassMainTypes(),
                        function (n, i) {
                            var o = on(t[n]),
                                s = un(r.get(n), o);
                            cn(s),
            ...
            findComponents: function (t) {
                ...
                return (function (e) {
                    ...
                    Xr(
                        i
                            ? this.queryComponents(i)
                            : this._componentsMap.get(n),
                        t
                    )
                );
            },
            eachComponent: function (t, e, n) {
                ...
                "function" == typeof t
                    ...
                    : x(t)
                    ? f(i.get(t), e, n)
                    : w(t) && f(this.findComponents(t), e, n);
            },
    ...
    Yr.prototype = {
        ...
        mountOption: function (t) {
            ...
            return (
                (this._timelineOptions = ed(e.timelineOptions, td)),
        ...
        getMediaOption: function (t) {
            ...
            return (
                !a.length && r && (a = [-1]),
                a.length &&
                    !Qr(a, this._currentMediaIndices) &&
                    (o = ed(a, function (t) {
    ...
    var fd = {
            arrayRows_column: {
                ...
                count: function () {
                    return Math.max(
                        0,
                        this._data.length - this._source.startIndex
                    );
                },
                getItem: function (t) {
            ...
            arrayRows_row: {
                ...
                count: function () {
                    var t = this._data[0];
                    return t
                        ? Math.max(0, t.length - this._source.startIndex)
                        : 0;
                },
                getItem: function (t) {
            ...
            objectRows: { pure: !0, count: da, getItem: pa, appendData: ga },
            keyedColumns: {
                pure: !0,
                count: function () {
                ...
                getItem: function (t) {
                    for (
                        var e = [], n = this._source.dimensionsDefine, i = 0;
                        i < n.length;
                        i++
                    ) {
            ...
            original: { count: da, getItem: pa, appendData: ga },
            typedArray: {
                persistent: !1,
                pure: !0,
                count: function () {
        ...
        pd = {
            ...
            original: function (t, e, n, i) {
                ...
                return (
                    !this._rawData.pure && hn(t) && (this.hasItemOption = !0),
        ...
        md = {
            ...
            getFormattedLabel: function (t, e, n, i, r) {
                ...
                return "function" == typeof l
                    ? ((s.status = e), l(s))
                    : "string" == typeof l
                    ? pr(l, s).replace(gd, function (e, n) {
                          var i = n.length;
                          return (
                              "[" === n.charAt(0) &&
                                  "]" === n.charAt(i - 1) &&
    ...
    (vd.perform = function (t) {
        ...
        if (
            ...
            var s = this._dueIndex,
                l = Math.min(
                    null != o ? this._dueIndex + o : 1 / 0,
                    this._dueEnd
                );
            !n &&
                (a || s < l) &&
                this._progress({ start: s, end: l }, this.context),
                (this._dueIndex = l);
        ...
        _d = Ef.extend({
            ...
            init: function (t, e, n, i) {
                (this.seriesIndex = this.componentIndex),
                    (this.dataTask = wa({ count: Ta, reset: Ca })),
    ...
    u(_d, md), u(_d, zf);
    var xd = function () {
        (this.group = new Wh()), (this.uid = Qi("viewComponent"));
    };
    xd.prototype = {
        constructor: xd,
        init: function (t, e) {},
        ...
        Cd = {
            ...
            reset: function (t, e) {
                var n = t.getData(),
                    ...
                    r =
                        t.get(i) ||
                        t.getColorFromPalette(t.name, null, e.getSeriesCount());
                        ...
                        (s += n(
                            ...
                            e.eachSeries(function (t, e) {
                                if (e < u) {
                                    ...
                                    (a +=
                                        f.join(i("data.separator.middle")) +
                                        i("data.separator.end")),
                                        d.push(a);
                                }
                            }),
                            (s +=
                                d.join(i("series.multiple.separator.middle")) +
                                i("series.multiple.separator.end")),
    ...
    (Ld.getPerformArgs = function (t, e) {
        if (t.__pipeline) {
            ...
            return {
                step:
                    ...
                    (!i || i.canProgressiveRender) &&
                    t.__idxInPipeline > n.bockIndex
                        ? n.step
                        : null,
            };
        }
        ...
        (Ld.prepareStageTasks = function () {
            var t = this._stageTaskMap,
                ...
                n = this.api;
            f(
                [this._dataProcessorHandlers, this._visualHandlers],
                function (i) {
                    f(
                        i,
                        function (i) {
        ...
        (Ld.performDataProcessorTasks = function (t, e) {
            Fa(this, this._dataProcessorHandlers, t, e, { block: !0 });
        }),
    ...
    za.wrapStageHandler = function (t, e) {
        return (
            _(t) && (t = { overallReset: t, seriesType: Ka(t) }),
    ...
    Qa(Ed, $f),
        Qa(Bd, Zr),
        (Ed.eachSeriesByType = Ed.eachRawSeriesByType =
            function (t) {
                Od = t;
            }),
    ...
    var Rd = [
        ...
        Fd = {
            ...
            timeline: {
                lineStyle: { color: "#eee" },
                itemStyle: { normal: { color: zd[1] } },
                label: { normal: { textStyle: { color: "#eee" } } },
                controlStyle: {
                    normal: { color: "#eee", borderColor: "#eee" },
                },
            },
            timeAxis: {
    ...
    var Vd = L,
        ...
        Yd = 3e3,
        jd = {
            PROCESSOR: { FILTER: Zd, STATISTIC: 5e3 },
            VISUAL: {
                LAYOUT: Ud,
                GLOBAL: 2e3,
                CHART: Yd,
    ...
    (Jd._onframe = function () {
        ...
        (Jd.setOption = function (t, e, n) {
            ...
            if (
                (Gd(e) &&
                    ((n = e.lazyUpdate), (i = e.silent), (e = e.notMerge)),
                (this[$d] = !0),
                !this._model || e)
            ) {
                var r = new Yr(this._api),
                    a = this._theme,
        ...
        (Jd.getSvgDataUrl = function () {
            if (Ul.svgSupported) {
                var t = this._zr;
                return (
                    f(t.storage.getDisplayList(), function (t) {
                        t.stopAnimation(!0);
                    }),
                    ...
                    f(up, function (u, c) {
                        if (u.group === e) {
                            ...
                            (a = i(d.left, a)),
                                ...
                                (s = r(d.right, s)),
                                (l = r(d.bottom, l)),
                                h.push({ dom: f, left: d.left, top: d.top });
                        }
                    });
                    var c = (s *= u) - (a *= u),
                        d = (l *= u) - (o *= u),
    ...
    var tp = {
        ...
        update: function (t) {
            ...
            if (e) {
                ...
                if (Ul.canvasSupported) i.setBackgroundColor(o);
                else {
                    var s = _t(o);
        ...
        updateView: function (t) {
            var e = this._model;
            e &&
                (Pa.markUpdateMethod(t, "updateView"),
                co(e),
    ...
    (Jd._initEvents = function () {
                ...
                this._zr.on(
                    ...
                    function (e) {
                        ...
                        if ("globalout" === t) n = {};
                            ...
                            var o =
                                r.dataModel ||
                                i.getSeriesByIndex(r.seriesIndex);
                            n =
                                (o &&
                                    o.getDataParams(r.dataIndex, r.dataType)) ||
                                {};
        ...
        (Jd.dispose = function () {
            if (!this._disposed) {
                (this._disposed = !0), yn(this.getDom(), pp, "");
                var t = this._api,
                    e = this._model;
    ...
    ko(2e3, Cd),
        ...
        Lo("default", function (t, e) {
            ...
            i
                .animateShape(!0)
                .when(1e3, { endAngle: (3 * Ad) / 2 })
                .start("circularInOut"),
                i
                    .animateShape(!0)
                    .when(1e3, { startAngle: (3 * Ad) / 2 })
                    .delay(300)
                    .start("circularInOut");
            var a = new Wh();
            return (
        ...
        Co({ type: "highlight", event: "highlight", update: "highlight" }, N),
        Co({ type: "downplay", event: "downplay", update: "downplay" }, N),
        Mo("light", Nd),
        Mo("dark", Fd);
    var vp = {};
    Po({
    ...
    var yp = R(["tooltip", "label", "itemName", "itemId", "seriesName"]),
        _p = w,
    ...
    (Cp.type = "list"),
        ...
        (Cp.initData = function (t, e, n) {
            (Tr.isInstance(t) || c(t)) &&
                (t = new fa(t, this.dimensions.length)),
                (this._rawData = t),
                (this._storage = {}),
                (this._indices = null),
                (this._nameList = e || []),
                ...
                (this.defaultDimValueGetter =
                    pd[this._rawData.getSource().sourceFormat]),
        ...
        (Cp._initDataFromProvider = function (t, e) {
            if (!(t >= e)) {
                for (
                    ...
                    if (v && v.length < i) {
                        for (
                            var y = new m(Math.min(e - d * i, i)), _ = 0;
                            _ < v.length;
                            _++
                        )
                            y[_] = v[_];
                ...
                for (var x = t; x < e; x++) {
                    ...
                    if (!r.pure) {
                        ...
                        w &&
                            !D &&
                            (null != n
                                ? (D = this._getNameFromStore(x))
                                : null != w.name && (l[x] = D = w.name));
        ...
        (Cp.getIndices = function () {
            if (this._indices)
                return new (t = this._indices.constructor)(
                    this._indices.buffer,
                    0,
                    this._count
                );
            for (
                var t = Ho(this), e = new t(this.count()), n = 0;
                n < e.length;
                n++
            )
                e[n] = n;
        ...
        (Cp.each = function (t, e, n, i) {
            if (this._count) {
                "function" == typeof t && ((i = n), (n = e), (e = t), (t = [])),
                    (n = n || i || this);
                for (
                    var r = (t = d(jo(t), this.getDimension, this)).length,
                        a = 0;
                    a < this.count();
                    a++
                )
        ...
        (Cp.filterSelf = function (t, e, n, i) {
            if (this._count) {
                ...
                return (
                    ...
                    (this._count = l),
                    (this._extent = {}),
                    (this.getRawIndex = this._indices ? Uo : Zo),
                    this
                );
            }
        }),
                ...
                if (i) {
                    ...
                    if (!u)
                        if (1 === i)
                            ...
                            for (m = 0; m < r; m++) {
                                for (
                                    var S = !0, M = this.getRawIndex(m), d = 0;
                                    d < i;
                                    d++
                                ) {
                                    var I = e[d];
                                    ((w = this._getFast(n, M)) < t[I][0] ||
                                        w > t[I][1]) &&
                                        (S = !1);
                                }
        ...
        (Cp.map = function (t, e, n, i) {
            ...
            (r._indices = this._indices),
                (r.getRawIndex = r._indices ? Uo : Zo);
            for (
                var a = r._storage,
                    o = [],
                    s = this._chunkSize,
        ...
        (Cp.downSample = function (t, e, n, i) {
            ...
            return (r._count = d), (r._indices = f), (r.getRawIndex = Uo), r;
        }),
    ...
    (Cp.setItemGraphicEl = function (t, e) {
        ...
        (Cp.cloneShallow = function (t) {
            ...
            return (
                (t.getRawIndex = t._indices ? Uo : Zo),
    ...
    var Rp = gi({
        ...
        Np = fs.prototype;
    (Np._createSymbol = function (t, e, n, i) {
        this.removeAll();
        var r = ls(t, -1, -1, 2, 2, e.getItemVisual(n, "color"));
        r.attr({ z2: 100, culling: !0, scale: cs(i) }),
            (r.drift = ds),
            (this._symbolType = t),
            this.add(r);
    }),
        (Np.stopSymbolAnimation = function (t) {
            this.childAt(0).stopAnimation(t);
        }),
        (Np.getSymbolPath = function () {
            return this.childAt(0);
        }),
        (Np.getScale = function () {
            return this.childAt(0).scale;
        }),
        (Np.highlight = function () {
            this.childAt(0).trigger("emphasis");
        }),
        (Np.downplay = function () {
            this.childAt(0).trigger("normal");
        }),
        (Np.setZ = function (t, e) {
            var n = this.childAt(0);
            (n.zlevel = t), (n.z = e);
        }),
        (Np.setDraggable = function (t) {
    ...
    var zp = ["itemStyle"],
        ...
        Vp = ["label"],
        Wp = ["emphasis", "label"];
    (Np._updateCommon = function (t, e, n, i) {
            ...
            var w = function () {
                    if (!this.incremental) {
                        ...
                        this.animateTo(
                            {
                                scale: [
                                    Math.max(1.1 * x[0], x[0] + 3),
                                    Math.max(1.1 * x[1], x[1] + 3 * t),
                                ],
                            },
                            400,
                            "elasticOut"
    ...
    Pa.extend({
        ...
        render: function (t, e, n) {
            ...
            if (d && c.type === i.type && S === this._step) {
                v && !p
                    ? (p = this._newPolygon(h, _, i, m))
                    : p && !v && (g.remove(p), (p = this._polygon = null));
                var M = Es(i, !1, t);
                g.setClipPath(M),
                    x && f.updateData(a, { isIgnore: w, clipShape: M }),
                    a.eachItemGraphicEl(function (t) {
                        t.stopAnimation(!0);
                    }),
                    (Ds(this._stackedOnPoints, _) && Ds(this._points, h)) ||
                        (m
                            ? this._updateAnimation(a, _, i, n, S, y)
                            : (S && ((h = Bs(h, i, S)), (_ = Bs(_, i, S))),
                              d.setShape({ points: h }),
                              p &&
                                  p.setShape({
                                      points: h,
                ...
                x && f.updateData(a, { isIgnore: w, clipShape: Es(i, !1, t) }),
                    S && ((h = Bs(h, i, S)), (_ = Bs(_, i, S))),
                    (d = this._newPolyline(h, i, m)),
                    v && (p = this._newPolygon(h, _, i, m)),
                    g.setClipPath(Es(i, !0, t));
            var I = Rs(a, i) || a.getVisual("color");
            d.useStyle(
                o(s.getLineStyle(), {
                    fill: "none",
                    stroke: I,
        ...
        highlight: function (t, e, n, i) {
            ...
            if (!(a instanceof Array) && null != a && a >= 0) {
                ...
                o.highlight();
            } else Pa.prototype.highlight.call(this, t, e, n, i);
        },
        downplay: function (t, e, n, i) {
            var r = t.getData(),
                a = pn(r, i);
            if (null != a && a >= 0) {
                ...
                o &&
                    (o.__temp
                        ...
                        : o.downplay());
            } else Pa.prototype.downplay.call(this, t, e, n, i);
        },
        _newPolyline: function (t) {
            var e = this._polyline;
            return (
                e && this._lineGroup.remove(e),
                (e = new Kp({ shape: { points: t }, silent: !0, z2: 10 })),
        ...
        _updateAnimation: function (t, e, n, i, r, a) {
            ...
            r &&
                ...
                (o.shape.points = u),
                Xi(o, { shape: { points: f } }, l),
                s &&
                    (s.setShape({ points: u, stackedOnPoints: c }),
                    Xi(s, { shape: { points: f, stackedOnPoints: d } }, l));
    ...
    (Ns.prototype.parse = function (t) {
        return t;
    }),
        (Ns.prototype.getSetting = function (t) {
            return this._setting[t];
        }),
        (Ns.prototype.contain = function (t) {
            var e = this._extent;
            return t >= e[0] && t <= e[1];
        }),
        (Ns.prototype.normalize = function (t) {
            var e = this._extent;
            return e[1] === e[0] ? 0.5 : (t - e[0]) / (e[1] - e[0]);
        }),
        (Ns.prototype.scale = function (t) {
            var e = this._extent;
            return t * (e[1] - e[0]) + e[0];
        }),
        (Ns.prototype.unionExtent = function (t) {
            var e = this._extent;
            t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1]);
        }),
        (Ns.prototype.unionExtentFromData = function (t, e) {
            this.unionExtent(t.getApproximateExtent(e));
        }),
        (Ns.prototype.getExtent = function () {
            return this._extent.slice();
        }),
        (Ns.prototype.setExtent = function (t, e) {
            var n = this._extent;
            isNaN(t) || (n[0] = t), isNaN(e) || (n[1] = e);
        }),
        (Ns.prototype.getTicksLabels = function () {
            for (var t = [], e = this.getTicks(), n = 0; n < e.length; n++)
                t.push(this.getLabel(e[n]));
            return t;
        }),
        (Ns.prototype.isBlank = function () {
            return this._isBlank;
        }),
        (Ns.prototype.setBlank = function (t) {
            this._isBlank = t;
        }),
        bn(Ns),
        Tn(Ns, { registerWhenExtend: !0 }),
    ...
    (eg.getOrdinal = function (t) {
        ...
        (eg.parseAndCollect = function (t) {
            ...
            if (n && !this._deduplication)
                return (
                    (e = this.categories.length), (this.categories[e] = t), e
                );
            var i = Fs(this);
            return (
                null == (e = i.get(t)) &&
        ...
        fg = og.extend({
            ...
            niceTicks: function (t, e, n) {
                ...
                var u = this.getSetting("useUTC")
                        ? 0
                        : 60 *
                          new Date(+i[0] || +i[1]).getTimezoneOffset() *
                          1e3,
                    c = [
                        Math.round(hg((i[0] - u) / h) * h + u),
                        Math.round(ug((i[1] - u) / h) * h + u),
                    ];
                qs(c, i),
                    (this._stepLvl = l),
                    (this._interval = h),
    ...
    fg.create = function (t) {
        return new fg({ useUTC: t.ecModel.get("useUTC") });
    };
    var pg = Ns.prototype,
        gg = og.prototype,
        mg = ir,
        ...
        bg = Ns.extend({
            ...
            $constructor: function () {
                Ns.apply(this, arguments), (this._originalScale = new og());
            },
            getTicks: function () {
                var t = this._originalScale,
                    ...
                    n = t.getExtent();
                return d(
                    gg.getTicks.call(this),
                    function (i) {
                        var r = nr(xg(this.base, i));
                        return (
                            (r = i === e[0] && t.__fixMin ? $s(r, n[0]) : r),
            ...
            scale: function (t) {
                return (t = pg.scale.call(this, t)), xg(this.base, t);
            },
            setExtent: function (t, e) {
                var n = this.base;
                (t = wg(t) / wg(n)),
            ...
            getExtent: function () {
                ...
                (e[0] = xg(t, e[0])), (e[1] = xg(t, e[1]));
                var n = this._originalScale,
                    i = n.getExtent();
                return (
                    n.__fixMin && (e[0] = $s(e[0], i[0])),
    ...
    f(["contain", "normalize"], function (t) {
        bg.prototype[t] = function (e) {
            return (e = wg(e) / wg(this.base)), pg[t].call(this, e);
        };
    }),
        (bg.create = function () {
            return new bg();
        ...
        (rl.prototype = {
            ...
            clampData: function (t, e) {
                ...
                return (
                    (e = e || []),
                    (e[0] = Math.min(
                        Math.max(Math.min(n[0], n[1]), t[0]),
                        Math.max(n[0], n[1])
                    )),
                    (e[1] = Math.min(
                        Math.max(Math.min(i[0], i[1]), t[1]),
                        Math.max(i[0], i[1])
                    )),
                    e
                );
            ...
            if (!t) {
                ...
                (t = n.get("interval")),
                    "category" !== this.type ||
                        (null != t && "auto" !== t) ||
                        (t = tl(
                            d(this.scale.getTicks(), this.dataToCoord, this),
    ...
    (kg.categoryAxis = i(
        ...
        (kg.valueAxis = i({ boundaryGap: [0, 0], splitNumber: 5 }, Dg)),
        (kg.timeAxis = o(
            { scale: !0, min: "dataMin", max: "dataMax" },
            kg.valueAxis
        )),
        (kg.logAxis = o({ scale: !0, logBase: 10 }, kg.valueAxis));
    var Ag = ["value", "category", "time", "log"],
                ...
                e.extend({
                    ...
                    optionUpdated: function () {
                        "category" === this.option.type &&
                            (this.__ordinalMeta = zs.createByAxisModel(this));
                    },
        ...
        Og = Ef.extend({
            ...
            axis: null,
            init: function () {
                Og.superApply(this, "init", arguments), this.resetRange();
            },
    ...
    (zg.type = "grid"),
            ...
            function i() {
                Bg(a, function (t) {
                    var e = t.isHorizontal(),
                        ...
                        i = t.inverse ? 1 : 0;
                    t.setExtent(n[i], n[1 - i]), dl(t, e ? r.x : r.y);
                });
            }
        ...
        (zg.getAxis = function (t, e) {
            ...
            if (null != n) {
                if (null == e)
                    for (var i in n) if (n.hasOwnProperty(i)) return n[i];
                return n[e];
            }
        }),
        (zg.getAxes = function () {
                ...
                t.eachSeries(function (i) {
                    if (gl(i)) {
                        var r = pl(i),
                            a = r[0],
                            o = r[1];
                        if (!sl(a, e, t) || !sl(o, e, t)) return;
                        var s = this.getCartesian(
                                a.componentIndex,
                                o.componentIndex
                            ),
                            l = i.getData(),
        ...
        (zg.getTooltipAxes = function (t) {
            var e = [],
                n = [];
            return (
                Bg(this.getCartesians(), function (i) {
                    var r =
                            null != t && "auto" !== t
                                ? i.getAxis(t)
                                : i.getBaseAxis(),
    ...
    var Hg = {
                    ...
                    var i,
                        ...
                        c = [
                            "start" === r
                                ...
                                ? h[1] + u * l
                                : (h[0] + h[1]) / 2,
                            bl(r) ? t.labelOffset + o * l : 0,
                        ],
                        f = e.get("nameRotate");
                    null != f && (f = (f * Vg) / 180);
                    var d;
                    bl(r)
                        ? (i = Gg(t.rotation, null != f ? f : t.rotation, o))
                        : ((i = vl(t, r, f || 0, h)),
                          null != (d = t.axisNameAvailableWidth) &&
                              ((d = Math.abs(d / Math.sin(i.rotation))),
                              !isFinite(d) && (d = null)));
                    var p = s.getFont(),
        ...
        qg = (Wg.ifIgnoreOnTick = function (t, e, n, i, r, a) {
            ...
            return (
                "ordinal" === s.type &&
                ("function" == typeof n
                    ? ((o = s.getTicks()[e]), !n(o, s.getLabel(o)))
                    : e % (n + 1))
            );
        }),
        ...
        Zg = Oo({
            ...
            render: function (t, e, n, i) {
                this.axisPointerClass && Il(t),
                    Zg.superApply(this, "render", arguments),
                    Al(this, t, 0, n, 0, !0);
            },
            ...
            dispose: function (t, e) {
                Ll(this, e), Zg.superApply(this, "dispose", arguments);
            },
        }),
        Ug = [];
        ...
        Qg = Zg.extend({
                ...
                if (
                    ...
                    f($g, s.add, s),
                        ...
                        f(
                            ...
                            function (e) {
                                t.get(e + ".show") &&
                                    this["_" + e](t, a, o.labelInterval);
                            },
                            this
                        ),
                        Yi(r, this._axisGroup, t),
            ...
            _splitArea: function (t, e, n) {
                ...
                if (!i.scale.isBlank()) {
                    ...
                    s = y(s) ? s : [s];
                    for (
                        var m = t.get("axisLabel.showMinLabel"),
                            v = t.get("axisLabel.showMaxLabel"),
                            _ = 1;
                        _ < h.length;
                        _++
                    )
                        if (
                            !(Yg(i, _, p, h.length, m, v) && _ < h.length - 1)
                        ) {
                            var x,
                                w,
                                b,
                                S,
                                M = i.toGlobalCoord(h[_]);
                            i.isHorizontal()
                                ? ((x = c),
                                  (w = l.y),
                                  (b = M - x),
    ...
    Qg.extend({ type: "xAxis" }),
        Qg.extend({ type: "yAxis" }),
        Oo({
            type: "grid",
            render: function (t, e) {
                this.group.removeAll(),
                ...
                return {
                    ...
                    reset: function (t) {
                        ...
                        if (n) {
                            ...
                            return (
                                is(e, r[0], r[1]) &&
                                    (r[0] = e.getCalculationInfo(
                                        "stackResultDimension"
                                    )),
                                is(e, r[1], r[0]) &&
                                    (r[1] = e.getCalculationInfo(
                                        "stackResultDimension"
                                    )),
                                a && {
                                    progress: function (t, e) {
                ...
                getMarkerPosition: function (t) {
                    ...
                    if (e) {
                        var n = e.dataToPoint(e.clampData(t)),
                            ...
                            a = i.getLayout("size");
                        return (
                            (n[e.getBaseAxis().isHorizontal() ? 0 : 1] +=
                                r + a / 2),
                            n
                        );
                    }
                ...
                a
                    ...
                    .update(function (e, n) {
                        ...
                        if (a.hasValue(e)) {
                            ...
                            l
                                ? Xi(l, { shape: c }, h, e)
                                : (l = nm[s.type](a, e, u, c, i, h, !0)),
                                a.setItemGraphicEl(e, l),
                                r.add(l),
                                Nl(l, a, e, u, c, t, i, "polar" === s.type);
                        } else r.remove(l);
                    })
                    .remove(function (t) {
    ...
    var nm = {
            ...
            polar: function (t, e, n, i, r, a, s) {
                var l = i.startAngle < i.endAngle,
                    h = new Yc({ shape: o({ clockwise: l }, i) });
                if (a) {
                    var u = h.shape,
                        c = r ? "r" : "endAngle",
                        f = {};
        ...
        v(function (t, e, n) {
            ...
            f(
                ...
                function (t) {
                    ...
                    (a[o] = a[o] || []), e.setLayout({ offset: l, size: h });
                    for (
                        var f = e.mapDimension(u.dim),
                            d = e.mapDimension(i.dim),
                            p = is(e, f, d),
                            g = u.isHorizontal(),
                            m =
                                i.onZero || p
                                    ? u.toGlobalCoord(u.dataToCoord(0))
                                    : u.getGlobalExtent()[0],
                            v = 0,
                            y = e.count();
                        v < y;
    ...
    var rm = function (t, e, n) {
        ...
        am = {
            ...
            toggleSelected: function (t, e) {
                ...
                if (null != n)
                    return (
                        this[n.selected ? "unSelect" : "select"](t, e),
                        n.selected
                    );
            },
    ...
    (sm.updateData = function (t, e, n) {
            ...
            n
                ? (s.setShape(c),
                  "scale" === l.getShallow("animationType")
                      ? ((s.shape.r = u.r0), Zi(s, { shape: { r: u.r } }, l, e))
                      : ((s.shape.endAngle = u.startAngle),
                        Xi(s, { shape: { endAngle: u.endAngle } }, l, e)))
                : Xi(s, { shape: c }, l, e);
        ...
        (sm._updateLabel = function (t, e) {
            ...
            Xi(
                ...
                Xi(i, { style: { x: o.x, y: o.y } }, r, e),
                i.attr({ rotation: o.rotation, origin: [o.x, o.y], z2: 10 });
            ...
            var f = u.get("smooth");
            f && !0 === f && (f = 0.4), n.setShape({ smooth: f });
        }),
        h(Wl, Wh);
    Pa.extend({
        type: "pie",
        ...
        _createClipPath: function (t, e, n, i, r, a, o) {
            ...
            return (
                Zi(
                    s,
                    { shape: { endAngle: i + (r ? 1 : -1) * Math.PI * 2 } },
                    o,
                    a
                ),
                s
    ...
    var lm = function (t, e, n, i) {
            ...
            o.each(function (n) {
                ...
                var k = p.getFont(),
                    ...
                    L = ee(
                        t.getFormattedLabel(n, "normal") || o.getName(n),
                        k,
                        c,
                        "top"
                    );
    ...
    !(function (t, e) {
        ...
        (t.init = function (t, e, n) {
            ...
            var r = new eo(t, e, n);
            return (
                (r.id = "ec_" + fp++), (up[r.id] = r), yn(t, pp, r.id), wo(r), r
            );
        }),
