!(function (t, e) {
    ...
    function rn(t) {
        ...
        ch.call(this),
            ...
            (this._handlers = {}),
            nn(this),
            Yl.pointerEventsSupported
                ? e(Su, this)
                : (Yl.touchEventsSupported && e(wu, this), e(xu, this));
    }
    function an(t, e) {
    ...
    function Tn(t, e) {
        function n(t) {
            var e = i[t.main];
            return (e && e[Nu]) || ((e = i[t.main] = {})[Nu] = !0), e;
        }
        e = e || {};
        var i = {};
        if (
    ...
    function Ln(t, e, n, i, r, a) {
        ...
        if (Cn(u) && Cn(c))
            ...
            if (Cn(p)) {
                ...
                (M =
                    (-s -
                        ((y = y < 0 ? -Gu(-y, Zu) : Gu(y, Zu)) +
                            (_ = _ < 0 ? -Gu(-_, Zu) : Gu(_, Zu)))) /
                    (3 * o)) >= 0 &&
                    M <= 1 &&
                    (a[d++] = M);
            } else {
    ...
    function di(t, e, n) {
        ...
        return null === i || null === r
            ...
            : [
                  (n ? Nn : Bn)(t.x1, t.cpx1, t.x2, e),
                  (n ? Nn : Bn)(t.y1, t.cpy1, t.y2, e),
              ];
    }
    function pi(t) {
        Ne.call(this, t),
    ...
    function Bi(t, e, n, i, r, a, o) {
        ...
        var d = c ? s : null,
            p = f
                ...
                : null;
        (null == d && null == p) || (Ni(t, n, a, r), Ni(e, i, o, r, !0)),
            (t.text = d),
            (e.text = p);
    }
    function Ni(t, e, n, i, r) {
    ...
    function Pa() {
        (this.group = new Wh()),
            ...
            (this.renderTask = wa({ plan: Ba, reset: Na })),
    ...
    function Va(t, e, n, i, r) {
        function a(n) {
            var a = n.uid,
                s =
                    o.get(a) ||
                    o.set(a, wa({ plan: Ua, reset: Ya, count: ja }));
            (s.context = {
                model: n,
                ecModel: i,
                api: r,
    ...
    function ls(t, e, n, i, r, a, o) {
        ...
        return (
            (l =
                0 === t.indexOf("image://")
                    ? vi(t.slice(8), new Nt(e, n, i, r), o ? "center" : "cover")
                    : 0 === t.indexOf("path://")
                    ? mi(
                          t.slice(7),
                          {},
    ...
    function Ts(t, e, n, i, r, a, o, s, l, h, u) {
        for (var c = 0, f = n, d = 0; d < i; d++) {
            ...
            if (f === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Yp(jp, p);
            else if (l > 0) {
                var g = f + a,
                    m = e[g];
    ...
    qh.prototype = {
        ...
        updateDisplayList: function (t) {
            ...
            (n.length = this._displayListLen), Yl.canvasSupported && qt(n, Xt);
        },
    ...
    Zh.prototype = {
        ...
        getGradient: function (t, e, n) {
            for (
                var i = ("radial" === e.type ? Yt : Ut)(t, e, n),
                    r = e.colorStops,
                    a = 0;
                a < r.length;
                a++
    ...
    (cu.prototype = {
        ...
        (Ne.prototype = {
            ...
            attrKV: function (t, e) {
                "style" !== t
                    ? Rh.prototype.attrKV.call(this, t, e)
                    : this.style.set(e);
            },
    ...
    pu.prototype = {
        ...
        pathToImage: function (t, e) {
            ...
            (t.position = [u - r.x, f - r.y]),
                ...
                t.updateTransform(),
                t && t.brush(i);
            var v = new Re({ style: { x: 0, y: 0, image: n } });
            return (
        ...
        attrKV: function (t, e) {
            "shape" === t
                ? (this.setShape(e),
                  (this.__dirtyPath = !0),
                  (this._rect = null))
                : Ne.prototype.attrKV.call(this, t, e);
        },
    ...
    var Xc = ai.extend({
        ...
        Yc = function (t) {
            return Yl.browser.ie && Yl.browser.version >= 11
                ? function () {
                      var e,
                          n = this.__clipPaths,
                          i = this.style;
        ...
        Kc = function (t, e, n, i) {
            ...
            for (var f = 0, d = t.length; f < d; f++) {
                ...
                var y = V([], p, u),
                    _ = V([], p, c);
                i && (j(y, y, o), Z(y, y, s), j(_, _, o), Z(_, _, s)),
                    l.push(y),
                    l.push(_);
            }
    ...
    (pi.prototype.getBoundingRect = function () {
        if (!this._rect) {
            for (
                var t = new Nt(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
            ...
            createIcon: function (t, e, n) {
                ...
                if (((n = n || { x: -1, y: -1, width: 2, height: 2 }), t))
                    return 0 === t.indexOf("image://")
                        ? ((i.image = t.slice(8)), o(i, n), new Re(e))
    ...
    var Nf = {
        ...
        zf = {
            clearColorPalette: function () {
                (Rf(this).colorIdx = 0), (Rf(this).colorNameMap = {});
            },
    ...
    var Vd = L,
        ...
        Zd = 3e3,
        jd = {
            PROCESSOR: { FILTER: Ud, STATISTIC: 5e3 },
            VISUAL: {
                LAYOUT: Yd,
                GLOBAL: 2e3,
                CHART: Zd,
    ...
    var tp = {
        ...
        update: function (t) {
            ...
            if (e) {
                ...
                if (Yl.canvasSupported) i.setBackgroundColor(o);
                else {
                    var s = _t(o);
    ...
    ko(2e3, Cd),
        ...
        Co({ type: "highlight", event: "highlight", update: "highlight" }, R),
        Co({ type: "downplay", event: "downplay", update: "downplay" }, R),
        Mo("light", Rd),
        Mo("dark", Fd);
    var vp = {};
    Po({
    ...
    (Cp.type = "list"),
        ...
        (Cp.downSample = function (t, e, n, i) {
            ...
            return (r._count = d), (r._indices = f), (r.getRawIndex = Yo), r;
        }),
    ...
    (Cp.setItemGraphicEl = function (t, e) {
        ...
        (Cp.cloneShallow = function (t) {
            ...
            return (
                (t.getRawIndex = t._indices ? Yo : Uo),
    ...
    var pg = Rs.prototype,
        ...
        bg = Rs.extend({
            ...
            $constructor: function () {
                Rs.apply(this, arguments), (this._originalScale = new og());
            },
            getTicks: function () {
    ...
    var Hg = {
        ...
        Ug = Oo({
            ...
            remove: function (t, e) {
                ...
                n && n.remove(e), Ug.superApply(this, "remove", arguments);
            },
            dispose: function (t, e) {
                Ll(this, e), Ug.superApply(this, "dispose", arguments);
            },
        }),
        Yg = [];
            ...
            _splitArea: function (t, e, n) {
                ...
                if (!i.scale.isBlank()) {
                    ...
                    for (
                        ...
                        if (
                            !(Zg(i, _, p, h.length, m, v) && _ < h.length - 1)
                        ) {
                            var x,
                                w,
                                b,
    ...
    var nm = {
            ...
            polar: function (t, e, n, i, r, a, s) {
                var l = i.startAngle < i.endAngle,
                    h = new Zc({ shape: o({ clockwise: l }, i) });
                if (a) {
                    var u = h.shape,
                        c = r ? "r" : "endAngle",
                        f = {};
            ...
            n
                ? (s.setShape(c),
                  "scale" === l.getShallow("animationType")
                      ? ((s.shape.r = u.r0), Ui(s, { shape: { r: u.r } }, l, e))
