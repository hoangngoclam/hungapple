...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form id="form" action="{{ route('admin.editSliderPost') }}" method="POST"
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title"
                                            class="form-control
                                    {{ $errors->slider->first('title') ? 'is-invalid' : '' }}"
                                            placeholder="Nhập vào" name="title"
                                            value="{{ old('title') ? old('title') : $slider->title }}" required>
                                        @if ($errors->slider->first('tilte'))
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <textarea
                                            ...
                                            name="content" rows="4"
                                            required>{{ old('content') ? old('content') : $slider->content }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ $errors->slider->first('status') ? 'is-invalid' : '' }}" id="status" name="status" required>
                                            ...
                                            <option {{$slider->status == 1 ? 'selected' : ''}} value="1">Hiển thị</option>
                                            <option {{$slider->status == 0 ? 'selected' : ''}} value="0">Không hiển thị</option>
                                        </select>
                                ...
                                <div class="col-md-8">
                                    ...
                                    {{ $errors->slider->first('productId') ? 'is-invalid' : '' }}"
                                            ...
                                            value="{{ old('productId') ? old('productId') : $slider->productId }}" required>
                            ...
                            <div>
                                ...
                                <div class="row" id="imagesPreview"> <a href="#" class="preview-image">
                                        <img class="img-fluid img-thumbnail" src="{{ url($slider->image) }}"
                                            alt="{{ url($slider->image) }}">
                                    </a></div>
