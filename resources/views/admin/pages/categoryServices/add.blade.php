...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.addServiceCategoryPost')}}" method="POST">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{$errors->category->first('meta_title') ? 'is-invalid' : ''}}" name="meta_title" rows="4"></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{$errors->category->first('meta_desc') ? 'is-invalid' : ''}}" name="meta_desc" rows="4"></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{$errors->category->first('meta_keywords') ? 'is-invalid' : ''}}" name="meta_keywords" rows="4"></textarea>
