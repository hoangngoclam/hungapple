...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form id="form" action="{{ route('admin.addProductPost') }}" method="POST"
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{ $errors->product->first('categoryId') ? 'is-invalid' : '' }}"
                                            ...
                                            <option selected disabled value="">---Chọn danh mục 1---</option>
                                            @if ($lvl1Categories)
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ $errors->product->first('price') ? 'is-invalid' : '' }}"
                                                placeholder="Nhập vào" id="price" name="price" value="{{ old('price') }}"
                                                required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {{ $errors->product->first('SKU') ? 'is-invalid' : '' }}"
                                            placeholder="Nhập vào" id="SKU" name="SKU" value="{{ old('SKU') }}"
                                            required>
                            ...
                            <div>
                                ...
                                @if ($errors->product->first('images[]'))
                                    <div class="invalid-feedback-custom">
                                        {{ $errors->product->first('images[]') }}
                                    </div>
                                @endif
                                <div class="row" id="imagesPreview"></div>
                                <div class="btn btn-info browseMediaBtn" data-toggle="modal"
        ...
        $('#categoryId').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#categoryIdLv2').html(
                        `<option selected disabled value="">---Chọn danh mục 2---</option>` +
                        listOptHtml);
                }
            });
        });
