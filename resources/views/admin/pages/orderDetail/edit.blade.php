                ...
                <div class="card-body">
                    <form id="form" action="{{ route('admin.editOrderDetailPost') }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="productId"
                                            ...
                                            placeholder="Nhập vào" name="productId" required value="{{$orderDetail->productId}}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="quantity"
                                            ...
                                            placeholder="Nhập vào" name="quantity" required value="{{$orderDetail->quantity}}">
                        ...
                        <div class="form-actions m-t-40">
                            ...
                            <button type="button" class="btn btn-dark btn-cancel">Danh sách đơn hàng #id = {{$orderDetail->orderId}}</button>
                        </div>
                    </form>
                </div>
            </div>
