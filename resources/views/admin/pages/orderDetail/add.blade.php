...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form id="form" action="{{ route('admin.addOrderDetailPost') }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="productId"
                                            ...
                                            placeholder="Nhập vào" name="productId" value="{{ old('productId') }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="quantity"
                                            ...
                                            placeholder="Nhập vào" name="quantity" value="{{ old('quantity') }}" required>
                        ...
                        <div class="form-actions m-t-40">
                            ...
                            <button type="button" class="btn btn-dark btn-cancel">Danh sách đơn hàng #id = {{$id}}</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('script')
    ...
    <script>
        ...
        $('.btn-cancel').on('click', function() {
            window.location = "{{ route('admin.orderDetail',['id' => $id]) }}";
        });
