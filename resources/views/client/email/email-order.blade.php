...
<body>
    <div class="es-wrapper-color">
                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7681" align="center">
                                        <table class="es-header-body"
                                            style="background-color: #ffffff;border: 2px solid #eb3e32; padding: 0px 20px;"
                                            width="600" cellspacing="0" cellpadding="0" bgcolor="#044767"
                                            align="center">
                                            <tbody>
                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p0r es-m-p20b esd-container-frame"
                                                                        width="340" valign="top" align="center">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c"
                                                                                        ...
                                                                                        <h1
                                                                                            ...
                                                                                            <img class="logo_dark"
                                                                                                src="https://hungapple.com/assets/images/logo/logo_icon_dark.png"
                                                                                                alt="logo">
                                                                                        </h1>
                                                                                    </td>
                                                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p40t es-p35r es-p35l" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            style="border-right: 2px solid #eb3e32; border-left: 2px solid #eb3e32; padding: 20px;">
                                                            <tbody>
                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p35r es-p35l"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            target="_blank"
                                                                                            href="#"><img
                                                                                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRo5KpCd2mIfIwU-MGHeS-JOBlMxvDt36o2Lg&usqp=CAU"
                                                                                                alt
                                                                                                style="display: block;"
                                                                                                width="120"></a></td>
                                                                                </tr>
                                            ...
                                            <tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l"
                                                                                        ...
                                                                                        style="padding: 0px 20px; border-right: 2px solid #eb3e32; border-left: 2px solid #eb3e32;">
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p35r es-p35l" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            style="padding: 0px 20px; border-right: 2px solid #eb3e32; border-left: 2px solid #eb3e32; border-bottom: 2px solid #eb3e32;">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="530"
                                                                        valign="top" align="center">
        ...
        <div class="text-center">
            <a href="https://hungapple.com/administrator/get-sign-in">Nhấn vào đây để đăng nhập admin</a>
        </div>
    </div>
</body>
