...
<head>
    @if (Route::is('client.home'))
        ...
        <meta name="title"
            content="Hưng apple | Điện thoại - Linh kiện - Phụ kiện - Sửa chữa và bảo hành điện thoại Đà Lạt">
        <meta name="description"
            content="Hưng apple | Cung cấp các mặt hàng linh kiện, phụ kiện, điện thoại. Đi kèm với dịch vụ như sửa chữa, ép kính, thay thế linh kiện chính hãng chất lượng cao tại Đà Lạt">
        <meta name="keywords" content="Điện thoại, Linh kiện, Phụ kiện giá rẻ, Sửa chữa và bảo hành điện thoại">

        <meta property="og:title"
            content="Hưng apple | Điện thoại - Linh kiện - Phụ kiện - Sửa chữa và bảo hành điện thoại">
        <meta property="og:description"
            content="Hưng apple | Cung cấp các mặt hàng linh kiện, phụ kiện, điện thoại. Đi kèm với dịch vụ như sửa chữa, ép kính, thay thế linh kiện chính hãng chất lượng cao tại Đà Lạt">
        <meta property="og:url" content="https://hungapple.com.vn">
    ...
    <meta property="og:site_name" content="hungapple.com.vn">
            ...
            <div class="container">
                <div class="nav_block">
                    <a class="navbar-brand" href="{{ route('client.home') }}">
                        <img class="logo_light" src="{{ asset('assets/images/logo/logo_icon_light.png') }}"
                            alt="logo" />
                        <img class="logo_dark" src="{{ asset('assets/images/logo/logo_icon_dark.png') }}"
                            alt="logo" />
                    </a>
                    ...
                    <div class="product_search_form">
                        <form action="{{ route('client.shop') }}">
                            <div class="input-group">
                                        ...
                                        <select id="searchTypeSelect">
                                            ...
                                            @if (isset($allCategoriesProcessed) && $allCategoriesProcessed)
                                                @foreach ($allCategoriesProcessed as $categoriesLv1)
                                                    <option value="{{ $categoriesLv1['id'] }}"
                                                        data-type="categoryLv1"
                                                    ...
                                                    @if (isset($categoriesLv1['categoriesLv2']) && $categoriesLv1['categoriesLv2'])
                                                        @foreach ($categoriesLv1['categoriesLv2'] as $categoryLv2)
                                                            <option value="{{ $categoryLv2['id'] }}"
                                                                data-type="categoryLv2"
                                ...
                                <input class="form-control" placeholder="Tìm kiếm sản phẩm ..." required=""
                                    type="text" name="keyword" value="{{ request()->get('keyword') }}">
                                    ...
                                    @if($listAllCategory)
                                        ...
                                        <li class="dropdown dropdown-mega-menu">
                                            @if($parentCategory["type"] == "product")
                                                <a class="dropdown-item nav-link {{count($parentCategory["childrenCategory"]) > 0 ? "dropdown-toggler": ""}}" 
                                                    href="{{ route('client.shop').'?cat1='.$parentCategory["id"] }}" data-toggle="dropdown">
                                                    <span>{{$parentCategory["name"]}}</span>
                                                </a>
                                            @else
                                                <a class="dropdown-item nav-link
                                                    {{count($parentCategory["childrenCategory"]) > 0 ? "dropdown-toggler": ""}}" 
                                                    href="{{ route('client.shop').'?cat1='.$parentCategory["id"] }}" data-toggle="dropdown">
                                                    <span>{{$parentCategory["name"]}}</span>
                                                </a>
                                            @endif
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="dropdown dropdown-mega-menu">
                                        <a class="dropdown-toggle nav-link" href="{{ route('client.shop') }}"
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a class="dropdown-item nav-link nav_item"
                                                                    href="{{ route('client.shop') }}">Tất cả</a>
                                                            </li>
                                                            <!-- <li class="dropdown-header" style="color: #eb3e32;">Iphone</li> -->
                                                            @foreach ($productCategorys as $productCategory)
                                                                <li><a class="dropdown-item nav-link nav_item"
                                                                        href="{{ route('client.shop') . '?cat1=' . $productCategory["id"] }}">{{ $productCategory["name"] }}</a>
                                                                </li>
                                                            @endforeach
                                    ...
                                    <li class="dropdown dropdown-mega-menu">
                                        <a class="dropdown-toggle nav-link" href="{{ route('client.serviceShop') }}"
                                            data-toggle="dropdown">
                                            Sửa chữa
                                        </a>
                                        <div class="dropdown-menu">
                                                ...
                                                @if (isset($serviceCategorys) && $serviceCategorys)
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            <li>
                                                                <a class="dropdown-item nav-link nav_item"
                                                                    href="{{ route('client.serviceShop') }}">Tất cả</a>
                                                            </li>
                                                            <!-- <li class="dropdown-header" style="color: #eb3e32;">Iphone</li> -->
                                                            @foreach ($serviceCategorys as $serviceCategory)
                                                                <li><a class="dropdown-item nav-link nav_item"
                                                                        href="{{ route('client.serviceShop') . '?cat1=' . $serviceCategory["id"] }}">{{ $serviceCategory["name"] }}</a>
                                                                </li>
                                                            @endforeach
                                ...
                                <li class="dropdown cart_dropdown">
                                    ...
                                    <a class="nav-link cart_trigger" href="#" data-toggle="dropdown">
                                        <i class="linearicons-cart"></i><span
                                            class="cart_count">{{ $totalQty }}</span>
                                    </a>
                                    <div class="cart_box dropdown-menu dropdown-menu-right">
                                        @if (count(Cart::content()))
                                            <ul class="cart_list">
                                                @foreach (Cart::content() as $cartItem)
                                                    <li>
                                                        <a data-rowid="{{ $cartItem->rowId }}"
                                                            href="javascript:void(0)" class="item_remove"
                                                            data-type="rmFromCartBtn"><i
                                                                class="ion-close"></i></a>
                                                        <a href="#"><img
                                                                src="{{ asset('assets/images/cart_thamb1.jpg') }}"
                                                                alt="cart_thumb1">{{ $cartItem->name }}</a>
                                                        <span class="cart_quantity"> {{ (int) $cartItem->qty }} x
                                                            <span class="cart_amount"> <span
                                                                    class="price_symbole"></span></span>{{ number_format((float) $cartItem->price, 0, '', '.') }}
                                                            VND</span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                            <div class="cart_footer">
                                                <p class="cart_total"><strong>Tổng giá:</strong> <span
                                                        class="cart_price">{{ number_format(floatval(str_replace([','], '', Cart::subtotal())), 0, '', '.') }}
                                                        VND<span class="price_symbole"></span></span></p>
                                                <p class="cart_buttons"><a href="{{ route('client.cart') }}"
                                                        class="btn btn-fill-line view-cart">Giỏ hàng</a>

                                                    @if (Session::get('user'))
                                                        <a href="{{ route('client.checkout') }}"
                                                            class="btn btn-fill-out checkout">thanh toán</a>
                                                    @else
                                        ...
                                        @else
                                            <div class="cart-empty cart-empty-list"><i
                                                    class="linearicons-cart-empty"></i>
                        ...
                        <div class="widget">
                            ...
                            <div class="newsletter_form rounded_input">
                                <form>
                                    ...
                                    <button class="btn-send" name="submit" value="Submit"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="footer_payment text-center text-md-right">
                            ...
                            <li><a href="#"><img src="{{ asset('assets/images/master_card.png') }}"
                                        alt="master_card"></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/paypal.png') }}" alt="paypal"></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/amarican_express.png') }}"
