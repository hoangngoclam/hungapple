            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                                ...
                                <div class="row shop_container grid">
                                    @foreach ($services as $service)
                                        <div class="col-md-4 col-6">
                                            @include('client.partials.service-card', ['service' => $service, 'listLayout' =>true])
                                        </div>
                                    @endforeach
                                </div>
                            @else
                        ...
                        <div class="row">
                            <div class="col-12">
                                {!! $services->appends(request()->input())->links('client.partials.pagination') !!}
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($serviceCategorys as $category)
                                <div class="widget">
                                    ...
                                    <ul class="widget_categories">
                                        @if (isset($serviceCategorys) && count($category["childrenCategory"]) > 0)
